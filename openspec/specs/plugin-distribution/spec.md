...
## Purpose
Defines how Nightshift is packaged and distributed as a Claude Code plugin, including the marketplace catalog at the repository root and the canonical plugin layout under `plugins/nightshift/`.
